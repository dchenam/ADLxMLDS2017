...
if __name__ == "__main__":
    ...
    if args.mode == 'test':
        import pandas as pd
        encoder_model.load_weights('models/seq2seq.h5', by_name=True)
        decoder_model.load_weights('models/seq2seq.h5', by_name=True)
        ...
        train(seq2seq_model, data, batch_size=int(args.batch_size))